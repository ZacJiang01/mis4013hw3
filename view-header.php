        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="carmanufacturer.php">Manufacturers</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="manufacturer-and-cars.php">Manufacturer and Cars</a></li>
                    <li class="nav-item"><a class="nav-link" href="piechart.php">Price Pie Graph</a></li>
                </ul>
            </div>
        </div>
    </nav>
